...
@section('content')
    <section class="hero_in restaurants_detail" style="background: url('{{$info['image_url']}}')!important; background-repeat: no-repeat!important; background-size: cover!important;">
        <div class="wrapper">
            <div class="container">
            ...
            <span class="magnific-gallery">
					...
					<a href="{{$info['photos'][1]}}" title="Photo title" data-effect="mfp-zoom-in"></a>
					<a href="{{$info['photos'][2]}}" title="Photo title" data-effect="mfp-zoom-in"></a>
				</span>
        </div>
    </section>
    <!--/hero_in-->
