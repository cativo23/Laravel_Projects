    ...
    <div class="container margin_60_35" style="transform: none;">
        <div class="row" style="transform: none;">
            ...
            <div class="col-lg-9" id="faq">
                <h4 class="nomargin_top">Privacy Policy and Responsibility To Our Users</h4>
                <p>In compliance with the Mexican Law: Ley Federal de Protección de Datos Personales en Protección de los Particulares (LFPDPPP, its acronym in Spanish), Bestday.com (Partner of Travel) provides you with the following Privacy Notice:</p>
                <div role="tablist" class="add_bottom_45 accordion_2" id="payment">
                    <div class="card">
                        <div class="card-header" role="tab">
                            <h5 class="mb-0">
                                <a data-toggle="collapse" href="#collapseOne_payment" aria-expanded="true"><i class="indicator ti-minus"></i>Entity responsible for protecting and processing your Personal Data</a>
                            </h5>
                        </div>

                        <div id="collapseOne_payment" class="collapse show" role="tabpanel" data-parent="#payment">
                            <div class="card-body">
                                <p>Viajes Beda S.A. de C.V. (hereinafter, “Bestday.com (Partner of Travel)”), located at Avenida Bonampak, Manzana 2, Lote 7, Supermanzana 10, Torre “B,” Cancún, Quintana Roo, C.P. 77500.</p>
                            </div>
                        </div>
                    </div>
                    <!-- /card -->
                        ...
                        <div class="card-header" role="tab">
                            <h5 class="mb-0">
                                <a class="collapsed" data-toggle="collapse" href="#collapseTwo_payment" aria-expanded="false">
                                    <i class="indicator ti-plus"></i>Means of obtaining Personal Data
                                </a>
                            </h5>
                        </div>
                        <div id="collapseTwo_payment" class="collapse" role="tabpanel" data-parent="#payment">
                            <div class="card-body">
                                <p>The personal data that Bestday.com (Partner of Travel) collects from you will be used solely for the purposes set out herein and may be obtained:</p>
                                <ul>
                                    <li>Directly by entering your data or using the online services through the webpage www.e-tsw.com (Partner of Travel)</li>
                                    <li>Directly through our call center.</li>
                                        <li>Personally through our booking agents.</li>
                                </ul>
                            </div>
                        </div>
                    </div>
                        ...
                        <div class="card-header" role="tab">
                            <h5 class="mb-0">
                                <a class="collapsed" data-toggle="collapse" href="#collapse4_payment" aria-expanded="false">
                                    <i class="indicator ti-plus"></i>Purpose of collected Personal Data
                                </a>
                            </h5>
                        </div>
                        <div id="collapse4_payment" class="collapse" role="tabpanel" data-parent="#payment">
                            <div class="card-body">
                                <p>Your data will be collected for the following main purposes that are necessary for the service that you request:
                                    - Processing, monitoring, updating, modification, cancellation and confirmation of the services that you booked with Bestday.com (Partner of Travel) through its means, for financial and credit purposes, in order to comply with the obligations assumed with you and with our suppliers.
                                </p><p>
                                    ...
                                    - To evaluate the quality of the service, conduct surveys about travel habits and preferences, to participate in contests and raffles, customer loyalty programs, as well as for the sending of promotions, offers, services and advertising (solely and exclusively for Bestday.com (Partner of Travel)).
                                </p><p>
                                    The Data Holder may immediately and at no cost request the cancellation of e-mail marketing from Bestday.com (Partner of Travel) by clicking on the “Unsuscribe” link.
                                    In the event that you do not wish your personal data to be processed for these additional purposes, you may send at this time a written statement via email to the email address privacidad@Bestday.com (Partner of Travel).</p>
                            </div>
                        </div>
                    </div>
                    <!-- /card -->
